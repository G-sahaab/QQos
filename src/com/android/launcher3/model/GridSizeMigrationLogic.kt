...
class GridSizeMigrationLogic {
    ...
    private fun solveGridPlacement(
        ...
        while (iterator.hasNext()) {
            ...
            // QQ Launcher: keep the user's existing layout when possible. Items are deferred to
    ...
    /**
     * QQ Launcher: returns true if [entry] can stay at its original cell with its original size in
