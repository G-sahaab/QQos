...
import app.qqlauncher.QQ LauncherProto;
...
public class DeviceGridState implements Comparable<DeviceGridState> {
    ...
    // QQ Launcher@2038c6722c1ebd977290492881023675e1cddecd: Backup creation
    @SuppressLint("WrongConstant")
    public DeviceGridState(QQ LauncherProto.GridState protoGridState) {
    ...
    public QQ LauncherProto.GridState toProtoMessage() {
        return QQ LauncherProto.GridState.newBuilder()
