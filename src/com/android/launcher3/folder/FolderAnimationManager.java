...
public class FolderAnimationManager implements FolderAnimationCreator {
    ...
    public AnimatorSet createAnimatorSet(boolean isOpening) {
        ...
        // Set up the Folder background (respects QQ Launcher folder color pref).
        int initialColor = QQ LauncherUtilsKt.resolveFolderPreviewColor(mContext);
        int finalColor = QQ LauncherUtilsKt.resolveFolderBackgroundColor(mContext);
