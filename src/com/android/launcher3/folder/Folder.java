...
import app.qqlauncher.util.EditTextExtensions;
...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    protected void onFinishInflate() {
        ...
        mBackground.setColor(QQ LauncherUtilsKt.resolveFolderBackgroundColor(getContext()));
        var alpha = QQ LauncherUtilsKt.getFolderBackgroundAlpha(getContext());
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        // QQ Launcher-TODO: Keyboard too close to Folder name edit?
