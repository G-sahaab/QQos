...
public class FolderPagedView extends PagedView<PageIndicatorDots> implements ClipPathView {
    ...
    private boolean mDisallowPagedViewInterceptForIconSwipe; // QQ Launcher: Icon swipe gesture feature
    ...
    /** QQ Launcher: Find icon at specific position */
    ...
    /** QQ Launcher: Find icon in cell layout */
    ...
    private CellLayout createAndAddNewPage() {
        ...
        // QQ Launcher: Find the correct folder size depending on which parent owned them
        if (mFolder.isInAppDrawer()) {
