...
import app.qqlauncher.util.CompatibilityKt;
...
public class StatusBarTouchController implements TouchController {
    ...
    private void vibrate() {
        // LC-Note: For pulling down on notification panel (default gesture config)
        if (!QQ LauncherAppKt.getQQ LauncherApp(mLauncher).isVibrateOnIconAnimation()) {
    ...
    private boolean canInterceptTouch(MotionEvent ev) {
        // QQ Launcher: Icon Swipe Gestures (For vertical down gestures)
