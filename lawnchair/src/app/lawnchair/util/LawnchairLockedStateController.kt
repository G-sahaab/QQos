...
object QQ LauncherLockedStateController {

    private const val TAG = "QQ LauncherLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-QQ LauncherLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): QQ LauncherLockedStateController {
