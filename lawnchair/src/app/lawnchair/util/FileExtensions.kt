...
val fileProviderAuthority: String = "${QQ LauncherApp.instance.packageName}.fileprovider"

fun String.path2Uri(): Uri? = File(this).file2Uri()

fun File.file2Uri(): Uri? = try {
    FileProvider.getUriForFile(QQ LauncherApp.instance, fileProviderAuthority, this)
} catch (e: Exception) {
    e.printStackTrace()
    null
}
