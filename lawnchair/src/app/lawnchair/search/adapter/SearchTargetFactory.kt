...
import app.qqlauncher.search.algorithms.data.FileInfo
import app.qqlauncher.search.algorithms.data.FileInfo.Companion.isImageType
import app.qqlauncher.search.algorithms.data.FolderInfo
...
import app.qqlauncher.util.calculateInSampleSize
import app.qqlauncher.util.createFilePreviewFallbackBitmap
import app.qqlauncher.util.createSmallSearchResultBitmap
import app.qqlauncher.util.createTextBitmap
import app.qqlauncher.util.file2Uri
import app.qqlauncher.util.mimeCompat
